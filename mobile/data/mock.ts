/**
 * Datos mock — sin base de datos, tal cual el prototipo FuelTrack.
 * Este es el "seam" donde en una fase posterior se enchufa la API real
 * (VehiculoController, TicketController, StatsController del backend).
 *
 * Nota: las credenciales mock del prototipo se descartaron a propósito:
 * el mobile ya usa autenticación JWT real (services/auth.ts).
 */
