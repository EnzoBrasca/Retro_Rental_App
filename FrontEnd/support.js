...
(() => {
  ...
  function createRuntime(doc = document) {
    ...
    function ensureFetched(name) {
      ...
      r.fetched = true;
      const paths = {
        'AuthScreen': 'src/screens/AuthScreen',
        'HomeScreen': 'src/screens/HomeScreen',
        'ScannerScreen': 'src/screens/ScannerScreen',
        'HistoryScreen': 'src/screens/HistoryScreen',
        'ProfileScreen': 'src/screens/ProfileScreen',
        'AdminScreen': 'src/screens/AdminScreen',
        'NavigationBar': 'src/components/NavigationBar',
        'TutorialOverlay': 'src/components/TutorialOverlay'
      };
      const subPath = paths[name] || encodeURIComponent(name);
      const url = COMPONENT_DIR + "/" + subPath + ".dc.html";
      fetch(url).then((res) => {
        if (!res.ok) {
          console.error(
